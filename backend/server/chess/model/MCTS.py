...
class MCTS(object):
    ...
    def search(self, game):
        ...
        if s not in self.Ps:
            # leaf node
            self.Ps[s], v = self.nnet.predict(game.board.board)
            legal_actions = sorted(game.board.get_legal_actions(game.cur_player)) #TODO: verify if this method of getting valid moves is correct
            valids = []
